 ...
 * @author shadow
 */
public class CustomDungeonSelect extends Content {
    public final static CustomDungeonSelect instance = new CustomDungeonSelect();
    private final static int SLOT = 54;
    public int offset = 0;
    public List<WorldConfig.CustomDungeon> list = new ArrayList<>();
    
    private CustomDungeonSelect() {
    ...
    public void onInventoryClick(InventoryClickEvent e) {
        if (!(e.getInventory().getHolder() instanceof CustomDungeonSelect)) {
            return;
        }
        ...
        CustomDungeonSelect holder = (CustomDungeonSelect) e.getInventory().getHolder();
    ...
    public void init() {
        list.clear();
        for(WorldConfig.CustomDungeon dungeon : WorldConfig.wc.custom_dungeon.values()) list.add(dungeon);
