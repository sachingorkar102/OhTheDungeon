...
import shadow_lib.async.io.papermc.lib.features.asyncchunks.AsyncChunks;
import shadow_lib.async.io.papermc.lib.features.asyncchunks.AsyncChunksSync;
import shadow_lib.async.io.papermc.lib.features.asyncteleport.AsyncTeleport;
import shadow_lib.async.io.papermc.lib.features.asyncteleport.AsyncTeleportSync;
import shadow_lib.async.io.papermc.lib.features.bedspawnlocation.BedSpawnLocation;
import shadow_lib.async.io.papermc.lib.features.bedspawnlocation.BedSpawnLocationSync;
import shadow_lib.async.io.papermc.lib.features.blockstatesnapshot.BlockStateSnapshot;
import shadow_lib.async.io.papermc.lib.features.blockstatesnapshot.BlockStateSnapshotBeforeSnapshots;
import shadow_lib.async.io.papermc.lib.features.blockstatesnapshot.BlockStateSnapshotNoOption;
import shadow_lib.async.io.papermc.lib.features.blockstatesnapshot.BlockStateSnapshotResult;
import shadow_lib.async.io.papermc.lib.features.chunkisgenerated.ChunkIsGenerated;
import shadow_lib.async.io.papermc.lib.features.chunkisgenerated.ChunkIsGeneratedApiExists;
import shadow_lib.async.io.papermc.lib.features.chunkisgenerated.ChunkIsGeneratedUnknown;
