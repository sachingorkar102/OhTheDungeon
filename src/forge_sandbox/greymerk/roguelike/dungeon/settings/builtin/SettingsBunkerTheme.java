...
public class SettingsBunkerTheme extends DungeonSettings{

	public static final SettingIdentifier ID = new SettingIdentifier(SettingsContainer.BUILTIN_NAMESPACE, "bunker");
	
	public SettingsBunkerTheme(){
