...
public class SupportedRoomGenerationStrategy extends AbstractRoomGenerationStrategy {
    ...
    @Override
    public void generate(AsyncWorldEditor world, Random random, Room room,
        ...
        for (int y = 0; y < room.getHeight(); y++) {
            ...
            for (int z = 0; z < room.getDepth(); z++) {
                for (int x = 0; x < room.getWidth(); x++) {
                    ...
                    if (blockState == null || blockState.getMaterial() == Material.AIR || blockState == IDungeonsBlockProvider.NULL_BLOCK) {
