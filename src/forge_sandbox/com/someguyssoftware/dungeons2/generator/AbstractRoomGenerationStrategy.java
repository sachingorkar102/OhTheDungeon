...
public abstract class AbstractRoomGenerationStrategy implements IRoomGenerationStrategy {
    ...
    protected void postProcess(AsyncWorldEditor world, Random random, Map<ICoords, Arrangement> post, 
        ...
        for (Map.Entry<ICoords, Arrangement> e : post.entrySet()) {
            ...
            if ((state1 != null && state1.isBlock()) ||
                    (state2 != null && state2.isBlock()) ||
                    (state3 != null && state3.isBlock()) ||
                    (state4 != null && state4.isBlock())) {
                flag = true;
            }
            if (!flag) return;
     ...
     */
    @Deprecated
    protected void postProcess(AsyncWorldEditor world, Random random, Map<ICoords, Arrangement> post, Layout layout, Theme theme, StyleSheet styleSheet, LevelConfig config) {
