...
public class Style {
     ...
     */
    public final Style setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    public final Style setBlock(String block) {
        this.block = block;
        return this;
    }
     ...
     */
    public final Style setDecay(double decay) {
        this.decay = decay;
        return this;
    }
     ...
     */
    public final Style setDecayBlocks(List<String> decayBlocks) {
