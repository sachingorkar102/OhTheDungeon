...
//     * 
//     */
//    public DungeonBuilder(AsyncWorldEditor world, ChunkSnapshot chunk) {
//        this.world = world;
...
//     * @param random
//     */
//    public DungeonBuilder(AsyncWorldEditor world, ChunkSnapshot chunk, Random random) {
//        this.world = world;
//        this.random = random;
//    }
//    
...
//        Dungeons2.log.debug("init level boundary -> {}, factor -> {}", new Object[] {levelBoundary, this.config.getLevelConfigs()[0].getBoundaryFactor()});
...
//                new Object[] {spawnBoundary, this.config.getLevelConfigs()[0].getSpawnBoundaryFactor()});
//        
//        /*
...
//         */
//        Boundary dungeonBoundary;
//        ICoords closestCoords;
