...
import forge_sandbox.jaredbgreat.dldungeons.planner.features.FeatureAdder;
import forge_sandbox.jaredbgreat.dldungeons.planner.features.IslandPlatform;
import forge_sandbox.jaredbgreat.dldungeons.planner.features.IslandRoom;
import forge_sandbox.jaredbgreat.dldungeons.planner.features.Pillar;
import forge_sandbox.jaredbgreat.dldungeons.planner.features.Pool;
...
public class Room extends AbstractRoom {
	...
	public Room(int beginX, int endX, int beginZ, int endZ, int floorY, int ceilY, 
		...
		hasEntrance = (isNode && !singleEntrance 
	...
	protected void addSpawners(Dungeon dungeon) {
		...
		int x, y, z, tmp, num;
		String mob;		
		if(!hasEntrance && (difficulty.multimob(dungeon.random) || isNode)) {
