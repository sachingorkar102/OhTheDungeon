...
//    }
     ...
     * @param z
     */
    public void place(AsyncWorldEditor world, int x, int y, int z) {
        if(isProtectedBlock(world, x, y, z)) return;
        world.setBlockState(x, y, z, block);
    }
    public void placeSync(World world, int x, int y, int z) {
        if(isProtectedBlockSync(world, x, y, z)) return;
        world.getBlockAt(x, y, z).setType(block);
    }
    public void placeAsync(AsyncWorldEditor world, int x, int y, int z) {
        world.setBlockType(x, y, z, block);
    }
     ...
     * @param block
     */
    public static void place(AsyncWorldEditor world, int x, int y, int z, int block) {
        if(!isProtectedBlock(world, x, y, z)) 
        registry.get(block).place(world, x, y, z);
    }
    public static void placeSync(World world, int x, int y, int z, int block) {
        if(!isProtectedBlockSync(world, x, y, z)) 
        registry.get(block).placeSync(world, x, y, z);
    }
    public static void placeAsync(AsyncWorldEditor world, int x, int y, int z, int block) {
     ...
     * @return true
     */
    public static boolean placeBlockSync(World world, int x, int y, int z, BlockData block) {
        if(isProtectedBlockSync(world, x, y, z)) return false;
        world.getBlockAt(x, y, z).setBlockData(block);
        return true;
    }
    public static boolean placeBlock(AsyncWorldEditor world, int x, int y, int z, BlockData block) {
        if(isProtectedBlock(world, x, y, z)) return false;
        world.setBlockData(x, y, z, block);
        return true;
    }
    public static boolean placeBlockAsync(AsyncWorldEditor world, int x, int y, int z, BlockData block) {
        if(isProtectedBlock(world, x, y, z)) return false;
        world.setBlockData(x, y, z, block);
        return true;
    }
        public static boolean placeBlock(AsyncWorldEditor world, int x, int y, int z, Material block) {
            if(isProtectedBlock(world, x, y, z)) return false;
            world.setBlockType(x, y, z, block);
        return true;
    }
        public static boolean placeBlockAsync(AsyncWorldEditor world, int x, int y, int z, Material block) {
            if(isProtectedBlock(world, x, y, z)) return false;
            world.setBlockType(x, y, z, block);
        return true;
    }
...
//    }
     ...
     * @param z
     */
    public static void deleteBlock(AsyncWorldEditor world, int x, int y, int z) {
        if(isProtectedBlock(world, x, y, z)) return;
        world.setBlockType(x, y, z, air);
    }
    public static void deleteBlockSync(World world, int x, int y, int z) {
        if(isProtectedBlockSync(world, x, y, z)) return;
     ...
     * @param flooded
     */
    public static void deleteBlock(AsyncWorldEditor world, int x, int y, int z, boolean flooded) {
        if(isProtectedBlock(world, x, y, z)) return;
        if(flooded) placeBlock(world, x, y, z, water); 
        else world.setBlockType(x, y, z, air);
    }
    public static void deleteBlockAsync(AsyncWorldEditor world, int x, int y, int z, boolean flooded) {
        if(isProtectedBlock(world, x, y, z)) return;
     ...
     * @param z
     */
    public static void placeChest(AsyncWorldEditor world, int x, int y, int z) {
     ...
     * @param mob
     */
    public static void placeSpawner(AsyncWorldEditor world, int x, int y, int z, EntityType mob) {
        if(isProtectedBlock(world, x, y, z)) return;
        if(!placeBlock(world, x, y, z, spawner)) return;
        
        Spawner_Later.generate_later(world, new Coord(x, y, z), mob);
    }
    ...
    public static boolean isGroundBlockSync(World world, int x, int y, int z) {
     ...
     * @return
     */
    public static boolean isProtectedBlock(AsyncWorldEditor world, int x, int y, int z) {
                Material block = world.getBlockState(x, y, z);
        return (block == chest || block == spawner
                || block == portal1 || block == portal2);
    }
    public static boolean isProtectedBlockSync(World world, int x, int y, int z) {
