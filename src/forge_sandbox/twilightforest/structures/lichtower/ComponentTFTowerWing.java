...
public class ComponentTFTowerWing extends StructureTFComponentOld {
    ...
    protected ComponentTFTowerWing(TFFeature feature, int i, int x, int y, int z, int pSize, int pHeight, BlockFace direction) {
        super(feature, i);
    ...
    protected boolean makeBridge(List<StructureTFComponent> list, Random rand, int index, int x, int y, int z, int wingSize, int wingHeight, Rotation rotation) {
...
//         }
     ...
     */
    protected void decorateFloor(AsyncWorldEditor world, Random rand, int floor, int bottom, int top, @Nullable Rotation ladderUpDir, @Nullable Rotation ladderDownDir, StructureBoundingBox sbb) {
...
//            }
     ...
     */
    protected void decorateWell(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        int cx = size / 2;
        int cz = cx;
        int cy = bottom;
     ...
     */
    protected void decorateSkeletonRoom(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        // skeleton spawner
     ...
     */
    protected void decorateZombieRoom(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        // zombie spawner
     ...
     */
    protected void decorateCactusRoom(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
     ...
     */
    protected void decorateTreasureChest(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        int cx = size / 2;
        int cz = cx;
     ...
     */
    protected void decorateSpiderWebs(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        for (int dy = bottom; dy < top; dy++) {
            int chance = (top - dy + 2);
            for (int dx = 1; dx <= size - 2; dx++) {
                for (int dz = 1; dz <= size - 2; dz++) {
     ...
     */
    protected void decorateFurniture(AsyncWorldEditor world, Random rand, int bottom, int freeSpace, StructureBoundingBox sbb) {
     ...
     */
    protected void decorateSolidRock(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        for (int dy = bottom; dy < top; dy++) {
            for (int dx = 1; dx <= size - 2; dx++) {
                for (int dz = 1; dz <= size - 2; dz++) {
     ...
     */
    protected void decorateLibrary(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
     ...
     */
    protected void decorateLibraryTreasure(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        switch (rand.nextInt(4)) {
            case 0:
            default:
     ...
     */
    protected void decorateFullLibrary(AsyncWorldEditor world, Random rand, int bottom, int top, Rotation ladderUpDir, Rotation ladderDownDir, StructureBoundingBox sbb) {
        // put some bookshelves around the room
        for (int dx = 1; dx <= size - 2; dx++) {
            for (int dz = 1; dz <= size - 2; dz++) {
                for (int dy = bottom; dy < top; dy++) {
     ...
     */
    protected void decorateTrap(AsyncWorldEditor world, Random rand, int bottom, int top, int ladderUpDir, int ladderDownDir, StructureBoundingBox sbb) {
    ...
    protected void decorateOneChain(AsyncWorldEditor world, Random rand, int dx, int decoTop, int length, int dz, StructureBoundingBox sbb) {
    ...
    protected void decorateFloatingVines(AsyncWorldEditor world, Random rand, int decoTop, StructureBoundingBox sbb) {
        ...
        final BlockData vineNorth = Bukkit.createBlockData("minecraft:vine[east=false,south=false,north=true,west=false,up=false]");
        final BlockData vineSouth = Bukkit.createBlockData("minecraft:vine[east=false,south=true,north=false,west=false,up=false]");
        final BlockData vineEast = Bukkit.createBlockData("minecraft:vine[east=true,south=false,north=false,west=false,up=false]");
        final BlockData vineWest = Bukkit.createBlockData("minecraft:vine[east=false,south=false,north=false,west=true,up=false]");
...
//            }
     ...
     */
    protected void makeWindowBlock(AsyncWorldEditor world, int x, int y, int z, Rotation rotation, StructureBoundingBox sbb, boolean realWindows) {
...
//            setBlockState(world, Material.GLASS_PANE, x, y, z, sbb);
     ...
     * Makes a window base
     */
    protected void makeWindowBase(AsyncWorldEditor world, int x, int y, int z, Rotation rotation, StructureBoundingBox sbb) {
        BlockFace temp = this.getCoordBaseMode();
        this.setCoordBaseMode(rotation.rotate(temp));
        BlockData state = StructureTFHelper.stoneSlabDouble;
...
//        int numFlights = ((this.height - 3) / rise) - 1;
     ...
     */
    protected void makeStairs5flight(AsyncWorldEditor world, Random rand, StructureBoundingBox sbb, int height, Rotation rotation, boolean useBirchWood) {
        BlockFace temp = this.getCoordBaseMode();

        this.setCoordBaseMode(rotation.rotate(temp));

        final BlockData bottomSlab = useBirchWood ?
                StructureTFHelper.birchSlab :
                StructureTFHelper.stoneSlab;
        final BlockData topSlab = useBirchWood ?
     ...
     */
    protected void makeStairs7flight(AsyncWorldEditor world, Random rand, StructureBoundingBox sbb, int height, Rotation rotation, boolean useBirchWood) {
        final BlockFace temp = this.getCoordBaseMode();

        this.setCoordBaseMode(rotation.rotate(temp));
        final BlockData slabBottom = useBirchWood ?
                StructureTFHelper.birchSlab :
                StructureTFHelper.stoneSlab;
        final BlockData slabTop = useBirchWood ?
                StructureTFHelper.birchSlabTop :
                StructureTFHelper.stoneSlabTop;
     ...
     *
     */
    protected void makeStairs9flight(AsyncWorldEditor world, Random rand, StructureBoundingBox sbb, int height, Rotation rotation, boolean useBirchWood) {
        //TODO: Can we just... not do this?
        BlockFace temp = this.getCoordBaseMode();
        this.setCoordBaseMode(rotation.rotate(temp));

        final BlockData slabBot = useBirchWood ?
                StructureTFHelper.birchSlab :
                StructureTFHelper.stoneSlab;
        final BlockData slabTop = useBirchWood ?
                StructureTFHelper.birchSlabTop :
     ...
     */
    protected void makeStairs15flight(AsyncWorldEditor world, Random rand, StructureBoundingBox sbb, int height, Rotation rotation, boolean useBirchWood) {
        BlockFace temp = this.getCoordBaseMode();
        ...
        final BlockData slabTop = useBirchWood ?
                StructureTFHelper.birchSlabTop :
                StructureTFHelper.stoneSlabTop;
        final BlockData slabDoub = useBirchWood ?
     ...
     */
    protected void generatePaintingsOnWall(AsyncWorldEditor world, Random rand, int howMany, int floorLevel, BlockFace direction, int minSize, StructureBoundingBox sbb) {
